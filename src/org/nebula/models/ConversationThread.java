...
public class ConversationThread {
	...
	public ConversationThread() {
		this.threadName = NebulaApplication.getInstance().getMyIdentity().createNewThreadName();
	}
	...
	public Conversation addConversation(List<String> members) {
		return addConversation(new Conversation(NebulaApplication.getInstance().getMyIdentity().createNewConversationName(),
				members));
	}
